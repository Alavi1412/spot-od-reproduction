...
| Tuned classical guardrails and offline OD reference prevent over-crediting | `results/metrics_summary.json`, `results/batch_wls_baseline/batch_wls_summary.csv`, `paper/tables/main_results.tex`, `paper/tables/batch_wls_baseline.tex` |
